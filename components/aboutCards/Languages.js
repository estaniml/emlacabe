...
const Languages = () => {
  ...
  return (
    <motion.div 
        className={ hover 
                ? "border border-slate-100 relative bg-slate-800/40 md:bg-orange-900/40 p-6 md:p-10 rounded-xl shadow-2xl shadow-slate-800 cursor-pointer transition-all duration-500 ease-linear animate-description"
